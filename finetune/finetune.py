...
class Arg:
    ...
    pretrained_tokenizer: str = 'beomi/kcbert-large'
...
class Model(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if self.args.lr_scheduler == 'cos':
            scheduler = {'scheduler' : CosineAnnealingWarmRestarts(optimizer, T_0=5, T_mult=2)}
...
def main():
    ...
    trainer.early_stopping_callback = False
    trainer.fit(model)
